    ...
    <ScrollAnimationWrapper animation="fade-up" delay={index * 50}>
      ...
      >
        ...
        <div className="relative z-10">
          <div className="reason-icon w-14 h-14 mb-6 rounded-xl bg-linear-to-br from-blue-100 to-purple-100 flex items-center justify-center border-2 border-blue-200">
