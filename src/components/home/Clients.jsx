...
export default function Clients() {
  ...
  return (
    <section className="relative py-20 md:py-32 px-6 overflow-hidden bg-linear-to-b from-white to-blue-50">
...
function ClientCard({ client }) {
  return (
    <div className="group relative glass-card rounded-lg md:rounded-xl p-3 md:p-6 hover-lift transition-all duration-300 cursor-pointer w-32 sm:w-48 md:w-64 border border-blue-100">
      {/* Logo */}
      <div className="mb-2 md:mb-4 flex items-center justify-center">
        <div className="w-20 h-20 sm:w-28 sm:h-28 md:w-32 md:h-32 rounded-lg bg-white border border-blue-200 flex items-center justify-center overflow-hidden group-hover:bg-blue-50 group-hover:border-blue-300 transition-all duration-300">
          <img 
            src={client.logo} 
